...
let refrain = "Oh we love \(schoolName), and it's the best. That's why we love \(schoolName) more than all the rest."

let song = "\(refrain)\nThere's potions, charms, and transfiguration. So much fun, it's like vacation!\n\(refrain)\nYes, \(refrain)"
